...
<script>
    import '../../public/css/CropTool.scss'
    import formatTime from '../assets/js/formatTime'
    import simplifySecond from '../assets/js/simplifySecond'
    ...
    export default {
        ...
        watch: {
            ...
            currentPlayingTime (currentTime) {
                ...
                this.currentCursorTime = currentTime
                this.currentCursorOffsetX = currentTime/this.timeToPixelRatio
        ...
        methods: {
            ...
            addListeners () {
                ...
                this.timeLineContainer.addEventListener('mouseup', e => {
                    ...
                    if (this.isCropping) {
                        console.log('裁剪状态取消'+this.currentCursorTime)
                        this.$emit('seek',this.currentCursorTime)
                        this.stopCropping()
                        return
                    }
                    ...
                    // 更新当前鼠标指向的时间
                    this.currentCursorTime = currentCursorOffsetX * this.timeToPixelRatio
                    console.log('curretnCursorTime:'+this.currentCursorTime)
                    this.$emit('seek',this.currentCursorTime)
                    // 鼠标点击新增裁剪片段
                    if (!this.isCropping) {
            ...
            playSelectedClip (index) {
                ...
                console.log('playingItem:'+this.playingIndex)
                if (!this.playingItem) {
                    return
                }
                this.isCropping = false
                const startTime = this.playingItem.startTime
                this.currentCursorOffsetX = this.playingItem.startTimeIndicatorOffsetX
            ...
            confirmCrop () {
                ...
                this.isSendingCrop = false
                // 输出裁剪片段
                this.$emit('crop',tempCropItemList)
                return tempCropItemList
            }
        },
    }
